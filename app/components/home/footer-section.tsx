        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div className="text-center">
                    ...
                    <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 JITO™. All Rights Reserved. Built with <a
                        href="https://flowbite.com"
                        className="text-blue-600 hover:underline dark:text-blue-500">JITO Jobs</a>
                </span>
